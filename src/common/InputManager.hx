...
class InputManager {
	static var keyCodeToLetter:haxe.ds.Map<Int, InputName> = [
		0 => InputName.mouseL, 1 => InputName.mouseR, 87 => InputName.w, 83 => InputName.s, 65 => InputName.a, 68 => InputName.d, 48 => InputName.num0,
		49 => InputName.num1, 50 => InputName.num2, 51 => InputName.num3, 52 => InputName.num4, 53 => InputName.num5, 54 => InputName.num6,
		55 => InputName.num7, 56 => InputName.num8, 57 => InputName.num9, 220 => InputName.bslash,
	];
	static var keysDownEventHandlers:haxe.ds.Map<InputName, haxe.ds.Map<String, (repeat:Bool) -> Void>> = [
		InputName.mouseL => [], InputName.mouseR => [], InputName.w => [], InputName.a => [], InputName.s => [], InputName.d => [], InputName.num0 => [],
		InputName.num1 => [], InputName.num2 => [], InputName.num3 => [], InputName.num4 => [], InputName.num5 => [], InputName.num6 => [],
		InputName.num7 => [], InputName.num8 => [], InputName.num9 => [], InputName.bslash => [],
	];
	...
	static var changeEventHandlers:haxe.ds.Map<InputName, haxe.ds.Map<String, (event:hxd.Event) -> Void>> = [InputName.mouseMove => [],];
	public static var keysPressed = [
		InputName.mouseL => false, InputName.mouseR => false, InputName.w => false, InputName.a => false, InputName.s => false, InputName.d => false,
		InputName.num0 => false, InputName.num1 => false, InputName.num2 => false, InputName.num3 => false, InputName.num4 => false, InputName.num5 => false,
		InputName.num6 => false, InputName.num7 => false, InputName.num8 => false, InputName.num9 => false, InputName.bslash => false,
	];
